// src/constants/hotelConstants.js
...
export const HOTEL_AVAILABILITY_REQUEST = 'HOTEL_AVAILABILITY_REQUEST';
export const HOTEL_AVAILABILITY_SUCCESS = 'HOTEL_AVAILABILITY_SUCCESS'; 
export const HOTEL_AVAILABILITY_FAIL = 'HOTEL_AVAILABILITY_FAIL'; 
